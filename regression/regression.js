...
const calMatInverse = (dataMat) =>{
	...
	for(let i=0;i<n;i++){
		...
		for(j=0;j<n;j++){
			...
			tmpArr.push(f(i+j)*calMat(tmpMat)/value)
		}
		retMat.push(tmpArr)
	}
...
let aMat = [[1.118769136871939, 8.999197059350594, 4.469326316860491, 2.498321026715548], 
            ...
            [5.31335303999767, 3.8771816480261734, 6.331749633598175, 3.0482822955506084]]
let val = -101.073983624
let inverse =[ [ -0.5256523685542962,-0.35371833345616455,1.2477083508950606,-1.3452214519413823 ],
			  [ -0.12285078703732974,-0.21100972830512996, 0.6829221431716715,-0.8415522316071704 ],
			  [ -0.019700439868012686,-0.11634676242525824,-0.08595555799951453,0.37990417235430474 ],
			  [ 1.113423676428106,1.1266121920141923,-2.864918088351807,2.9541323218072404 ] ]


// [[-0.52565237 -0.35371833  1.24770835 -1.34522145]
//  [-0.12285079 -0.21100973  0.68292214 -0.84155223]
//  [-0.01970044 -0.11634676 -0.08595556  0.37990417]
//  [ 1.11342368  1.12661219 -2.86491809  2.95413232]] 
